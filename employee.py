...
class employeeClass:
    def __init__(self,root):
      ...
      #====options===
        ...
        #=====conetent======
        #====row1=====
        lbl_empide=Label(self.root,text="Emp ID",font=("goudy old style",15),bg="white").place(x=50,y=150)
        ...
        cmb_utype.current(0)
         ...
         #=======row 4 =======
        lbl_city=Label(self.root,text="City",font=("goudy old style",15),bg="white").place(x=50,y=270)
